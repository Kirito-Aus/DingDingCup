...
# 读取 CSV 文件
df = pd.read_csv('first_15days_prepared_and_last_15days_use_situation/class_1.csv')

# 提取需要的列
X = df.iloc[:, 2:-2].to_numpy()
selected_columns = ['is_used_app_label']
...
for k in range(k1, k2):
    ...
    print('k = ', k, ' LogisticRegression Accuracy: ', lr_accuracy)
